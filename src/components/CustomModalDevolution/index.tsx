...
const ModalTester: React.FC = (props) => {
        ...
        <View>
          {/* <View style={{width: 170}}> */}
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('DevolutionConfirmation', {id: props.idSolicitation, date: props.date, hours: props.hours})}
            > 
              <Text style={{color: '#fff'}}>DEVOLVER</Text>
            </TouchableOpacity>           
          {/* </View> */}
        </View>
      </Modal>
