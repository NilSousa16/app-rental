...
import { TextView, Topic, TextContract, Container, ButtonsArea, ViewTime, TextContainer} from './styles';
import { TitleOrder } from '../Historic/styles';

const DevolutionConfirmation: React.FC = () => {
    ...
    <>
      ...
      <Container>
        ...
        <View style={
          ...
          <TextInput       style={{color: '#a9a4b7'}}   
            underlineColorAndroid="transparent"
            placeholder="Digite aqui qual produto deseja devolver e o motivo da devolução"
              ...
              <CustomButton style={{height: 40}}
                onPress={
                  () => { 
                    ...
                    navigation.navigate('SuccessDevolution', {id: route.params.id});
                  }
                }
              >
                Confirmar
...
export default DevolutionConfirmation;
